...
output.fisheries.recordfrequency.ndt.sp0 = 1 #yield
output.fisheries.recordfrequency.ndt.sp1 = 1 #yield
output.fisheries.recordfrequency.ndt.sp2 = 1 #yield
output.fisheries.recordfrequency.ndt.sp3 = 1 #yield
output.fisheries.recordfrequency.ndt.sp4 = 1 #yield
output.fisheries.recordfrequency.ndt.sp5 = 1 #yield
output.fisheries.recordfrequency.ndt.sp6 = 1 #yield
output.fisheries.recordfrequency.ndt.sp7 = 1 #yield
output.fisheries.recordfrequency.ndt.sp8 = 1 #yield
output.fisheries.recordfrequency.ndt.sp9 = 1 #yield
output.fisheries.recordfrequency.ndt.sp10 = 1 #yield
output.fisheries.recordfrequency.ndt.sp11 = 1 #yield
output.fisheries.recordfrequency.ndt.sp12 = 1 #yield
output.fisheries.recordfrequency.ndt.sp13 = 1 #yield
output.fisheries.recordfrequency.ndt.sp14 = 1 #yield
output.fisheries.recordfrequency.ndt.sp15 = 1 #yield
