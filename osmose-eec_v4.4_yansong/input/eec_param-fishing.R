...
fisheries.rate.base.fsh3 = 0.27

# fishing effort are aggregated by year
fisheries.period.number.fsh0 = 20
fisheries.period.number.fsh1 = 20
fisheries.period.number.fsh2 = 20
fisheries.period.number.fsh3 = 20
...
fisheries.rate.byperiod.fsh3 = 1.02,1.12,1.30,1.33,1.38,1.31,1.00,0.66,0.81,0.89,0.93,0.86,1.00,0.94,1.05,1.02,0.98,0.90,0.72,0.78
